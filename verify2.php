...
if(isset($_POST['verification'])){
 ...
 $pass=$_SESSION['pass1']; 
    ...
    if($_SESSION['otp']==$_POST['otp']){
        ...
        $conn=$db->connect();
        $res=mysqli_query($conn, "insert into patient(fname,lname,age,gender,dob,bloodGroup,address,city,state,contact,email,password) values('$name', '$lname', '$age', '$gender', '$dob', '$bloodgroup', '$address', '$city', '$state', '$contact','$email','$pass')");
        if($res){
